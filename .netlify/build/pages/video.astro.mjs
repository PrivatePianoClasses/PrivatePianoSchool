...
import { c as createAstro, a as createComponent, r as renderTemplate, e as renderComponent, u as unescapeHTML, m as maybeRenderHead, b as addAttribute } from '../chunks/astro/server_DPUJ33nA.mjs';
import 'kleur/colors';
import { d as getVideos, u as urlFor, e as $$Button, $ as $$Layout } from '../chunks/Layout_BQYMmc8m.mjs';
/* empty css                                 */
...
}, "C:/Users/Dell/Downloads/PrivatePianoSchool/PrivatePianoSchool-main/PrivatePianoSchool-main/node_modules/@astro-community/astro-embed-twitter/Tweet.astro", void 0);
...
}, "C:/Users/Dell/Downloads/PrivatePianoSchool/PrivatePianoSchool-main/PrivatePianoSchool-main/node_modules/@astro-community/astro-embed-youtube/YouTube.astro", void 0);
...
}, "C:/Users/Dell/Downloads/PrivatePianoSchool/PrivatePianoSchool-main/PrivatePianoSchool-main/node_modules/@astro-community/astro-embed-vimeo/Vimeo.astro", void 0);
...
}, "C:/Users/Dell/Downloads/PrivatePianoSchool/PrivatePianoSchool-main/PrivatePianoSchool-main/node_modules/@astro-community/astro-embed-link-preview/LinkPreview.astro", void 0);
...
const $$Video = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Video Gallery", "headerimg": headImg, "HIcenter": center, "data-astro-cid-mnpmyww2": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="buttonnav" data-astro-cid-mnpmyww2> <div class="instruction" data-astro-cid-mnpmyww2><p data-astro-cid-mnpmyww2>Click any button to jump to video content.</p></div> ${renderComponent($$result2, "Button", $$Button, { "text": "Piano Performances", "link": "#piano", "data-astro-cid-mnpmyww2": true })} ${renderComponent($$result2, "Button", $$Button, { "text": "Choir Performances", "link": "#choir", "data-astro-cid-mnpmyww2": true })} ${renderComponent($$result2, "Button", $$Button, { "text": "Archived Performances", "link": "#archive-content", "classname": "archive-btn", "data-astro-cid-mnpmyww2": true })} </section>  <section id="piano" class="videocategory" data-astro-cid-mnpmyww2> <h2 class="categorytitle" data-astro-cid-mnpmyww2>Piano Performances</h2> ${content.pianoperfs.map(
    (section) => renderTemplate`<div class="videosection" data-astro-cid-mnpmyww2> <h3 class="sectiontitle" data-astro-cid-mnpmyww2>${section.title}</h3> <h3 class="sectiondate" data-astro-cid-mnpmyww2>${section.date}</h3> <div class="videos" data-astro-cid-mnpmyww2> ${section.videos.map(
      (video) => renderTemplate`<div class="video" data-astro-cid-mnpmyww2> ${renderComponent($$result2, "YouTube", $$YouTube, { "id": video.url, "data-astro-cid-mnpmyww2": true })} <p class="videocaption" data-astro-cid-mnpmyww2>${video.caption}</p> </div>`
    )} </div> </div>`
  )} </section>  <section id="choir" class="videocategory" data-astro-cid-mnpmyww2> <h2 class="categorytitle" data-astro-cid-mnpmyww2>Choir Performances</h2> ${content.choirperfs.map(
    (section) => renderTemplate`<div class="videosection" data-astro-cid-mnpmyww2> <h3 class="sectiontitle" data-astro-cid-mnpmyww2>${section.title}</h3> <h3 class="sectiondate" data-astro-cid-mnpmyww2>${section.date}</h3> <div class="videos" data-astro-cid-mnpmyww2> ${section.videos.map(
      (video) => renderTemplate`<div class="video" data-astro-cid-mnpmyww2> ${renderComponent($$result2, "YouTube", $$YouTube, { "id": video.url, "data-astro-cid-mnpmyww2": true })} <p class="videocaption" data-astro-cid-mnpmyww2>${video.caption}</p> </div>`
    )} </div> </div>`
  )} </section>  <section id="archive" class="videocategory" data-astro-cid-mnpmyww2> <div class="show-archive" data-astro-cid-mnpmyww2>${renderComponent($$result2, "Button", $$Button, { "text": "Show Archived Performances", "link": "#!", "classname": "archive-btn", "data-astro-cid-mnpmyww2": true })}</div> <div id="archive-content" data-astro-cid-mnpmyww2> <h2 class="categorytitle" data-astro-cid-mnpmyww2>Archived Performances</h2> ${content.archiveperfs ? content.archiveperfs.map(
    (section) => renderTemplate`<div class="videosection" data-astro-cid-mnpmyww2> <h3 class="sectiontitle" data-astro-cid-mnpmyww2>${section.title}</h3> <h3 class="sectiondate" data-astro-cid-mnpmyww2>${section.date}</h3> <div class="videos" data-astro-cid-mnpmyww2> ${section.videos.map(
      (video) => renderTemplate`<div class="video" data-astro-cid-mnpmyww2> ${renderComponent($$result2, "YouTube", $$YouTube, { "id": video.url, "data-astro-cid-mnpmyww2": true })} <p class="videocaption" data-astro-cid-mnpmyww2>${video.caption}</p> </div>`
    )} </div> </div>`
  ) : renderTemplate`<div class="videosection" data-astro-cid-mnpmyww2><p data-astro-cid-mnpmyww2>No Archived Performances</p></div>`} </div> </section> ` })}  <style>
  lite-youtube {
    border-radius: 10px;
  }
</style> `;
}, "C:/Users/Dell/Downloads/PrivatePianoSchool/PrivatePianoSchool-main/PrivatePianoSchool-main/src/pages/video.astro", void 0);

const $$file = "C:/Users/Dell/Downloads/PrivatePianoSchool/PrivatePianoSchool-main/PrivatePianoSchool-main/src/pages/video.astro";
const $$url = "/video";
